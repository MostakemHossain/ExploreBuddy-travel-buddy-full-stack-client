...
var $this=this.$element.hasClass('mkdf-header-effect');if($.support.transition&&this.$element.hasClass('slide')){var timer;timer=setTimeout(function(){mkdf.modules.shortcodes.mkdfCheckSliderForHeaderStyle($next,$this);$next.addClass(type)
$next[0].offsetWidth
